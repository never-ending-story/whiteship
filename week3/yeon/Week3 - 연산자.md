...
비트연산자의 경우에 <span style="color:blue">**산술 변환 규칙**</span>에 의해 <u>32bit짜리</u> int타입간의 연산이 일어난다. 
...
예) 10진수 10을 비트 전환 연산하면 결과는 -11이다. 이 값은 <u>10의 '1의 보수'</u>이다.

비트 전환 연산자도 피연산자의 타입이 int보다 작으면 <u>int로 산술 변환이 일어나고 연산한다.</u> 
...
하지만 >> 연산자의 경우 오른쪽으로 이동시키기 때문에 <u>왼쪽 피연산자가 음수인 경우 빈자리를 1로 채운다.</u> 
